...
# node
alias gatsby='docker run -it --rm -p 8000:8000 -v ${PWD}:/data -w /data -u $(id -u):$(id -g) node npx gatsby'
...
alias npm='docker run -it --rm -p 8000:8000 -v ${PWD}:/data -w /data -u $(id -u):$(id -g) node npm'
